package ro.penteker.auktion.utils.impl;
...
public class UtilsImpl implements Utils {
  ...
  @TriggersRemove(cacheName = "ro.penteker.auktion.eccrs.persistence", when = When.AFTER_METHOD_INVOCATION, removeAll = true)
  public void reset() {
    LOG.info("Resetting caches.");
  }

  @Cacheable(cacheName = "ro.penteker.auktion.eccrs.selects")
