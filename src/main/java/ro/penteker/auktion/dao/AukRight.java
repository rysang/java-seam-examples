 ...
 */
@Entity
@Table(name = "auk_right", uniqueConstraints = { @UniqueConstraint(columnNames = { "role_id", "product_id" }) })
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "AukRight.findAll", query = "SELECT a FROM AukRight a"),
